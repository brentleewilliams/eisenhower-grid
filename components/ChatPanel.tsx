...
export function ChatPanel() {
  ...
  return (
    <>
      {open && (
        <div className="fixed bottom-20 right-4 z-40 flex h-[28rem] w-[min(22rem,calc(100vw-2rem))] flex-col overflow-hidden rounded-lg border border-black/[.08] bg-white shadow-xl sm:right-6">
          <div
          ...
          <div ref={scrollRef} className="font-ui flex-1 space-y-3 overflow-y-auto px-3 py-3 text-sm">
            {messages.length === 0 && (
